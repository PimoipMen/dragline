...
class Modelbase extends CI_Model {
     ...
     * 后台系统分页列表
     */
    public function grid($select = "*", $filter = NULL, $page = 1, $page_size = 6, $sidx = NULL, $sord = NULL, $order = NULL, $isCount = TRUE)
    {
        ...
        $grid = array("page" => $page, "records" => $records, "rows" => $rows, "total" => $total, "query_sql" => $query_sql, "count_sql" => $count_sql, "code" => 0);
        //writelog($grid);
        return $grid;
    }
